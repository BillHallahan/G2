...
operator `++` from the source [here](http://hackage.haskell.org/package/base-4.7.0.2/docs/src/GHC-List.html#concat). Likewise, concat is
based off of the library `concact` function. Because why
try to reinvent the wheel, when some very, very smart
Haskell core devs wrote these clearly well working functions.
