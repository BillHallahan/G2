...
nearest k n centers p = fst $ minimumBy (\(x1, x2) (x3, x4) -> compare (distance n x2 p) (distance n x4 p)) (M.toList centers)
\end{code}
...
-- >>> test_nearest
-- 1
test_nearest = nearest 3 2 (M.fromList [(0, p0), (1, p2), (2, p1)]) p
  where
    p, p0, p1, p2 :: Point
