...
\begin{code}
{-@ length :: v:(List a) -> {a:Int | a = (size v)}@-}
length            :: List a -> Int
length Emp        = 0
...
\begin{code}
{-@ concatHelper :: l1: List a -> l2: List a -> {l3:List a | (size l3) = (size l1) + (size l2)} @-}
concatHelper Emp l2 = l2
concatHelper (h:+:t) l2 = h:+:(concatHelper t l2)

{-@ concat :: l1: List (List a) -> {l2: List a | (nestSize l1) = (size l2)} @-}
concat Emp = Emp
concat (h:+:t) = concatHelper h (concat t)
