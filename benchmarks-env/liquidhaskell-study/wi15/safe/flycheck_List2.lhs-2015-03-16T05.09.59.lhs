...
@-}
{-@ measure nonEmptyL :: List a -> Bool @-}
nonEmptyL :: List a -> Bool
nonEmptyL Emp       = False
nonEmptyL ((:+:) x y) = True

{-@ measure nonempty :: List (List a) -> Bool @-}
nonempty :: List (List a) -> Bool                        
nonempty (Emp)        = False
nonempty ((:+:) x xs) = nonEmptyL x || nonempty xs
