...
nearest k n centers p = floor $ distance n p minVal
  where minKey = minKeyMap centers       -- center (Int)
        minVal = M.findWithDefault (Center 0) minKey centers -- point  (List Double)
\end{code}
