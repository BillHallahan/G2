...
nearest k n centers p = minKeyMap $ M.map distance2 centers
	where distance2 = distance n p 
\end{code}
...
\begin{code}
{-@ measure size2	:: Map Int (List Double) -> Int
    size2 (CenteringKN k n) = size n
    size2 (CenteringKN k Emp) = 0
  @-}
{-@ kmeans1 :: k:Nat -> n:Nat ->
               List (PointN n) -> c1:CenteringKN k n -> {c2:CenteringKN k n | size2 c1 == size2 c2}
  @-}
