...
{-@ measure concatHelperMeasure      :: List a ->  List (List a) -> Int 
     concatHelperMeasure x1 Emp        = size x1
     concatHelperMeasure x1 ( x2 :+: xs) = size (append x1 x2) + size (concatHelperMeasure xs) 
  @-}
...
concatHelper x1  (x2 :+: xs) =  append (append x1 x2) (concatHelper xs)
