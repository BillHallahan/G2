...
nearest k n centers p = M.findWithDefault 0 minDis disMap
 where disMap = foldr (\(k1,p1) acc -> M.insert (distance p p1) k1 acc) M.empty (M.toList centers)
       minDis = minKeyMap disMap
\end{code}
