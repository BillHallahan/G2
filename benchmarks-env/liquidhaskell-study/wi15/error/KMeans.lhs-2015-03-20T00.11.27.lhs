...
nearest k n centers p = minKeyMap (Map.map (distance n p) centers)

{-@ distanceN :: n -> PointN n -> PointN n -> Double @-}
distanceN n px py = sqrt $ foldr (+) 0 $ zipWith (\x y -> (x-y)^2) px py
