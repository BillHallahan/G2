...
newtype N1 = N1 Int deriving Eq
newtype N2 = N2 N1 deriving Eq
newtype N3 = N3 N2 deriving Eq
newtype N4 = N4 N3 deriving Eq
...
newtype EInt a = EInt (E Int a) deriving Eq
...
data T a b c = TL a | TC b | TR c deriving Eq
newtype TFloat a b = TFloat (T a Float b) deriving Eq
...
newtype TFloat' a b = TFloat' (T b Float a) deriving Eq
