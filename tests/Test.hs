...
verifierTests = testGroup "Verifier"
    ...
    , checkExprNotVerified "tests/Verify/Int1.hs" "p1False"
    , checkExprNotVerified "tests/Verify/Int1.hs" "p2False"
    , checkExprNotVerified "tests/Verify/Int1.hs" "p2False'"
    , checkExprNotVerified "tests/Verify/Int1.hs" "p3False"
    ...
    , checkExprNotVerified "tests/Verify/List1.hs" "prop10False"
