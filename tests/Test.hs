...
testFileTests = testGroup "TestFiles"
    ...
    , checkInputOutputsTemplate "tests/HigherOrder/RankN.hs" [ ("identity", 50, [AtLeast 1])
                                                             ...
                                                             , ("twoTVs", 60, [AtLeast 2])
                                                             , ("twoTVsMultiCall", 200, [AtLeast 1])
                                                             , ("nested", 100, [AtLeast 2])
                                                             , ("calledInTuple", 100, [AtLeast 2])
                                                             , ("intArg", 100, [AtLeast 2])
                                                             , ("intArgCalledTwice", 200, [AtLeast 5])
                                                             , ("intArgCaseFourCalls", 500, [AtLeast 44])
                                                             , ("multiIntArgs", 200, [AtLeast 4])
                                                             , ("fromMaybe", 200, [AtLeast 3])
                                                             , ("fromMaybeInvalid", 100, [AtLeast 0])
    ...
    , checkInputOutputsTemplate "tests/HigherOrder/RankN2.hs" [ ("identityInTuple", 100, [AtLeast 1])
                                                              ...
                                                              , ("boxedRet", 100, [AtLeast 1]) 
                                                              , ("treeRet", 100, [AtLeast 5]) 
                                                              , ("treeRet2", 300, [AtLeast 1]) 
