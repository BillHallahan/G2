...
verifierTests = testGroup "Verifier"
    ...
    , checkExprCEx "tests/Verify/List1.hs" "p4False"
    , checkExprCEx "tests/Verify/List1.hs" "p5False"
    , checkExprCEx "tests/Verify/List1.hs" "p6False"
    , checkExprCEx "tests/Verify/List1.hs" "p7False"
    , checkExprCEx "tests/Verify/List1.hs" "p9False"
