...
liquidTests = testGroup "Liquid" 
    ...
    , checkLiquid "tests/Liquid/IO/IO3.hs" "f" 1400 1 [AtLeast 1]
...
primTests = testGroup "Prims"
    ...
    , checkInputOutput "tests/Prim/Prim4.hs" "Prim4" "divIntTest" 1500 1 [AtLeast 4]
    , checkInputOutput "tests/Prim/Prim4.hs" "Prim4" "divIntegerTest" 1500 1 [AtLeast 1]
    , checkInputOutput "tests/Prim/Prim4.hs" "Prim4" "divIntegerTest2" 1500 1 [AtLeast 4]
    , checkInputOutput "tests/Prim/Prim4.hs" "Prim4" "divFloatTest" 1500 1 [AtLeast 1]
    ]
