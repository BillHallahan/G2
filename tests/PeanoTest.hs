...
zeroPeano :: Expr
zeroPeano =
    Data $ DataCon (Name "Zero" (Just "Peano") 0 Nothing) (TyConApp (Name "Peano" (Just "Peano") 0 Nothing) TYPE)

succPeano :: Expr -> Expr
succPeano x =
    App (Data $ DataCon (Name "Succ" (Just "Peano") 0 Nothing) (TyConApp (Name "Peano" (Just "Peano") 0 Nothing) TYPE)) x
