...
zeroPeano :: Expr
zeroPeano =
    Data $ DataCon (Name "Zero" (Just "Peano") 0 ProvOther) (TyCon (Name "Peano" (Just "Peano") 0 ProvOther) TYPE) [] []

succPeano :: Expr -> Expr
succPeano x =
    App (Data $ DataCon (Name "Succ" (Just "Peano") 0 ProvOther) (TyCon (Name "Peano" (Just "Peano") 0 ProvOther) TYPE) [] []) x
