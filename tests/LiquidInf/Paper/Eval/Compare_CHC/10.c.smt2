(set-info :original "/tmp/sea-tkguiO/10.pp.ms.o.bc")
...
(rule (=> (and (main@entry @__VERIFIER_nondet_int_0)
         ...
         main@.lr.ph_0
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0) (= main@%y.0.i4_0 0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0) (= main@%w.0.i3_0 1))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0) (= main@%z.0.i2_0 0))
         ...
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0)
             (= main@%z.0.i2_1 main@%z.0.i2_0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0)
             (= main@%x.0.i1_1 main@%x.0.i1_0)))
    (main@.lr.ph main@%w.0.i3_1
                 main@%x.0.i1_1
                 main@%z.0.i2_1
                 main@%y.0.i4_1
...
(rule (let ((a!1 (and (main@entry @__VERIFIER_nondet_int_0)
                ...
                (=> main@verifier.error_0
                    (= main@%_11_0 (= main@%x.0.i.lcssa_1 main@%y.0.i.lcssa_1)))
                (=> main@verifier.error_0 (not main@%_11_0))
                (=> main@verifier.error.split_0
                    (and main@verifier.error.split_0 main@verifier.error_0))
                main@verifier.error.split_0)))
  (=> a!1 main@verifier.error.split)))
(rule (=> (and (main@.lr.ph main@%w.0.i3_0
                      main@%x.0.i1_0
                      main@%z.0.i2_0
                      main@%y.0.i4_0
                      @__VERIFIER_nondet_int_0)
         true
         (= main@%_3_0 (= main@%w.0.i3_0 0))
         (= main@%_4_0 (ite main@%_3_0 1 0))
         (= main@%not..i_0 (xor main@%_3_0 true))
         (= main@%_5_0 (ite main@%not..i_0 1 0))
         (= main@%x.1.i_0 (+ main@%_5_0 main@%x.0.i1_0))
         (= main@%w.1.i_0 (ite main@%_3_0 main@%w.0.i3_0 main@%_4_0))
         (= main@%_6_0 (= main@%z.0.i2_0 0))
         (= main@%_7_0 (ite main@%_6_0 1 0))
         (= main@%z.1.i_0 (ite main@%_6_0 main@%_7_0 main@%z.0.i2_0))
         (= main@%y.1.i_0 (+ main@%y.0.i4_0 main@%_7_0))
         ...
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%y.0.i4_1 main@%y.1.i_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%w.0.i3_1 main@%w.1.i_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%z.0.i2_1 main@%z.1.i_0))
         ...
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%z.0.i2_2 main@%z.0.i2_1))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%x.0.i1_2 main@%x.0.i1_1)))
    (main@.lr.ph main@%w.0.i3_2
                 main@%x.0.i1_2
                 main@%z.0.i2_2
                 main@%y.0.i4_2
                 @__VERIFIER_nondet_int_0)))
