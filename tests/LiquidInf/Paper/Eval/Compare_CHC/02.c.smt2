(set-info :original "/tmp/sea-dz3i0d/02.pp.ms.o.bc")
...
(declare-var main@%w.0.i4_2 Int )
(declare-var main@%y.0.i3_2 Int )
...
(declare-var main@%w.0.i4_0 Int )
(declare-var main@%y.0.i3_0 Int )
(declare-var main@%x.0.i2_0 Int )
(declare-var main@%z.0.i1_0 Int )
(declare-var main@%w.0.i4_1 Int )
(declare-var main@%y.0.i3_1 Int )
...
(rule (=> (and (main@entry @__VERIFIER_nondet_int_0)
         ...
         main@.lr.ph_0
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0) (= main@%w.0.i4_0 0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0) (= main@%y.0.i3_0 0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0) (= main@%x.0.i2_0 0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0) (= main@%z.0.i1_0 1))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0)
             (= main@%w.0.i4_1 main@%w.0.i4_0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0)
             (= main@%y.0.i3_1 main@%y.0.i3_0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0)
             (= main@%x.0.i2_1 main@%x.0.i2_0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0)
             (= main@%z.0.i1_1 main@%z.0.i1_0)))
    (main@.lr.ph main@%x.0.i2_1
                 main@%z.0.i1_1
                 main@%y.0.i3_1
                 main@%w.0.i4_1
...
(rule (let ((a!1 (and (main@entry @__VERIFIER_nondet_int_0)
                ...
                (=> main@verifier.error_0
                    (= main@%_14_0 (= main@%x.0.i.lcssa_1 main@%y.0.i.lcssa_1)))
                (=> main@verifier.error_0 (not main@%_14_0))
                (=> main@verifier.error.split_0
                    (and main@verifier.error.split_0 main@verifier.error_0))
                main@verifier.error.split_0)))
  (=> a!1 main@verifier.error.split)))
(rule (=> (and (main@.lr.ph main@%x.0.i2_0
                      main@%z.0.i1_0
                      main@%y.0.i3_0
                      main@%w.0.i4_0
                      @__VERIFIER_nondet_int_0)
         true
         (= main@%_3_0 (+ main@%x.0.i2_0 main@%z.0.i1_0))
         (= main@%_4_0 (+ main@%_3_0 main@%y.0.i3_0))
         (= main@%_5_0 (+ main@%_4_0 main@%w.0.i4_0))
         (= main@%_6_0 (+ main@%y.0.i3_0 1))
         (= main@%_7_0 (rem main@%_5_0 2))
         (= main@%_8_0 (= main@%_7_0 1))
         (= main@%_9_0 (ite main@%_8_0 1 0))
         (= main@%.x.0.i_0 (+ main@%_9_0 main@%x.0.i2_0))
         (= main@%_10_0 (+ main@%w.0.i4_0 2))
         ...
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%w.0.i4_1 main@%_10_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%y.0.i3_1 main@%_6_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%x.0.i2_1 main@%.x.0.i_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%z.0.i1_1 main@%_5_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%w.0.i4_2 main@%w.0.i4_1))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%y.0.i3_2 main@%y.0.i3_1))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%x.0.i2_2 main@%x.0.i2_1))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%z.0.i1_2 main@%z.0.i1_1)))
    (main@.lr.ph main@%x.0.i2_2
                 main@%z.0.i1_2
                 main@%y.0.i3_2
                 main@%w.0.i4_2
                 @__VERIFIER_nondet_int_0)))
(rule (let ((a!1 (and (main@.lr.ph main@%x.0.i2_0
                             main@%z.0.i1_0
                             main@%y.0.i3_0
                             main@%w.0.i4_0
                             @__VERIFIER_nondet_int_0)
                ...
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%y.0.i.lcssa_0 main@%.lcssa_1))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%x.0.i.lcssa_0 main@%.x.0.i.lcssa_1))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%y.0.i.lcssa_1 main@%y.0.i.lcssa_0))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%x.0.i.lcssa_1 main@%x.0.i.lcssa_0))
