(set-info :original "/tmp/sea-N32zSi/01.pp.ms.o.bc")
...
(rule (=> (and (main@entry @__VERIFIER_nondet_int_0)
    ...
    (main@.lr.ph main@%x.0.i1_1 @__VERIFIER_nondet_int_0)))
(rule (=> (and (main@entry @__VERIFIER_nondet_int_0)
         true
         (= main@%_0_0 @__VERIFIER_nondet_int_0)
         (= main@%_2_0 (= main@%_1_0 0))
...
(rule (=> (and (main@.lr.ph main@%x.0.i1_0 @__VERIFIER_nondet_int_0)
         true
    ...
    (main@.lr.ph main@%x.0.i1_2 @__VERIFIER_nondet_int_0)))
(rule (let ((a!1 (and (main@.lr.ph main@%x.0.i1_0 @__VERIFIER_nondet_int_0)
                true
                (= main@%factor_0 (* main@%x.0.i1_0 2))
                (= main@%_3_0 @__VERIFIER_nondet_int_0)
                (= main@%_5_0 (= main@%_4_0 0))
