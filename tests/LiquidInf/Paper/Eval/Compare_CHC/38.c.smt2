(set-info :original "/tmp/sea-yezSj8/38.pp.ms.o.bc")
...
(declare-var main@%.lcssa12_1 Int )
(declare-var main@%.lcssa_1 Int )
(declare-var main@%i.0.i3_2 Int )
...
(declare-var main@%.y.0.i.lcssa_0 Int )
(declare-var main@%.lcssa12_0 Int )
(declare-var main@%.lcssa_0 Int )
(declare-var main@%phitmp7_0 Bool )
(declare-var main@%phitmp8_0 Int )
...
(rule (=> (and (main@entry @__VERIFIER_nondet_int_0)
         ...
         main@.lr.ph_0
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0) (= main@%i.0.i3_0 0))
    ...
    (main@.lr.ph main@%i.0.i3_1 main@%x.0.i1_1 main@%y.0.i2_1 main@%_1_0)))
(rule (let ((a!1 (and (main@entry @__VERIFIER_nondet_int_0)
                ...
                (=> main@verifier.error_0
                    (= main@%_9_0 (= main@%x.0.i.lcssa_1 main@%y.0.i.lcssa_1)))
                (=> main@verifier.error_0
                    (= main@%or.cond.i_0 (or main@%_9_0 main@%i.0.i.lcssa_1)))
                (=> main@verifier.error_0 (not main@%or.cond.i_0))
                (=> main@verifier.error.split_0
                    (and main@verifier.error.split_0 main@verifier.error_0))
                main@verifier.error.split_0)))
  (=> a!1 main@verifier.error.split)))
(rule (=> (and (main@.lr.ph main@%i.0.i3_0 main@%x.0.i1_0 main@%y.0.i2_0 main@%_1_0)
         true
         (= main@%_3_0 (+ main@%i.0.i3_0 1))
         (= main@%_4_0 (+ main@%x.0.i1_0 1))
         (= main@%_5_0 (rem main@%_3_0 2))
         (= main@%_6_0 (= main@%_5_0 0))
         (= main@%_7_0 (ite main@%_6_0 1 0))
         (= main@%.y.0.i_0 (+ main@%_7_0 main@%y.0.i2_0))
         (= main@%_8_0 (< main@%_3_0 main@%_1_0))
         (=> main@.lr.ph_1 (and main@.lr.ph_1 main@.lr.ph_0))
         main@.lr.ph_1
         (=> (and main@.lr.ph_1 main@.lr.ph_0) main@%_8_0)
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%i.0.i3_1 main@%_3_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%y.0.i2_1 main@%.y.0.i_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%x.0.i1_1 main@%_4_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
    ...
    (main@.lr.ph main@%i.0.i3_2 main@%x.0.i1_2 main@%y.0.i2_2 main@%_1_0)))
(rule (let ((a!1 (=> main@verifier.error.loopexit_0
               (= main@%phitmp7_0 (not (= main@%phitmp_0 0))))))
(let ((a!2 (and (main@.lr.ph main@%i.0.i3_0
                             main@%x.0.i1_0
                             main@%y.0.i2_0
                             main@%_1_0)
                true
                ...
                (=> (and main@verifier.error.loopexit_0 main@.lr.ph_0)
                    (= main@%.lcssa12_0 main@%_4_0))
                (=> (and main@verifier.error.loopexit_0 main@.lr.ph_0)
                    (= main@%.lcssa_0 main@%_3_0))
                (=> (and main@verifier.error.loopexit_0 main@.lr.ph_0)
                    (= main@%.y.0.i.lcssa_1 main@%.y.0.i.lcssa_0))
                (=> (and main@verifier.error.loopexit_0 main@.lr.ph_0)
                    (= main@%.lcssa12_1 main@%.lcssa12_0))
                (=> (and main@verifier.error.loopexit_0 main@.lr.ph_0)
                    (= main@%.lcssa_1 main@%.lcssa_0))
                (=> main@verifier.error.loopexit_0
                    (= main@%phitmp_0 (rem main@%.lcssa_1 2)))
                a!1
                (=> main@verifier.error.loopexit_0
                    (= main@%phitmp8_0 (* main@%.y.0.i.lcssa_1 2)))
                (=> main@verifier.error_0
                    (and main@verifier.error_0 main@verifier.error.loopexit_0))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%i.0.i.lcssa_0 main@%phitmp7_0))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%y.0.i.lcssa_0 main@%phitmp8_0))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%x.0.i.lcssa_0 main@%.lcssa12_1))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%i.0.i.lcssa_1 main@%i.0.i.lcssa_0))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%y.0.i.lcssa_1 main@%y.0.i.lcssa_0))
