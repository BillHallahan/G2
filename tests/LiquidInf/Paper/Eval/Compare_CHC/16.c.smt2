(set-info :original "/tmp/sea-LYYvib/16.pp.ms.o.bc")
...
(rule (=> (and (main@entry @__VERIFIER_nondet_int_0)
         ...
         (=> (and main@.lr.ph.preheader_0 main@entry_0) (not main@%_4_0))
         (=> main@.lr.ph_0 (and main@.lr.ph_0 main@.lr.ph.preheader_0))
         main@.lr.ph_0
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0)
             (= main@%y.0.i2_0 main@%_3_0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0)
             (= main@%x.0.i1_0 main@%_1_0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0)
             (= main@%y.0.i2_1 main@%y.0.i2_0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0)
             (= main@%x.0.i1_1 main@%x.0.i1_0)))
    (main@.lr.ph main@%_1_0 main@%_3_0 main@%x.0.i1_1 main@%y.0.i2_1)))
(rule (let ((a!1 (=> main@verifier.error_0
               (= main@%_8_0 (not (= main@%_1_0 main@%_3_0))))))
(let ((a!2 (and (main@entry @__VERIFIER_nondet_int_0)
                ...
                a!1
                (=> main@verifier.error_0
                    (= main@%_9_0 (= main@%y.0.i.lcssa_1 0)))
                (=> main@verifier.error_0
                    (= main@%or.cond.i_0 (or main@%_8_0 main@%_9_0)))
                (=> main@verifier.error_0 (not main@%or.cond.i_0))
                (=> main@verifier.error.split_0
                    (and main@verifier.error.split_0 main@verifier.error_0))
                main@verifier.error.split_0)))
  (=> a!2 main@verifier.error.split))))
(rule (=> (and (main@.lr.ph main@%_1_0 main@%_3_0 main@%x.0.i1_0 main@%y.0.i2_0)
         true
         (= main@%_5_0 (+ main@%x.0.i1_0 (- 1)))
         ...
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%x.0.i1_1 main@%_5_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%y.0.i2_2 main@%y.0.i2_1))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%x.0.i1_2 main@%x.0.i1_1)))
    (main@.lr.ph main@%_1_0 main@%_3_0 main@%x.0.i1_2 main@%y.0.i2_2)))
(rule (let ((a!1 (=> main@verifier.error_0
               (= main@%_8_0 (not (= main@%_1_0 main@%_3_0))))))
(let ((a!2 (and (main@.lr.ph main@%_1_0
                             main@%_3_0
                             main@%x.0.i1_0
                             main@%y.0.i2_0)
                true
