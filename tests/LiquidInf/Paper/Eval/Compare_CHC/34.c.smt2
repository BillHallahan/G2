(set-info :original "/tmp/sea-uzNto8/34.pp.ms.o.bc")
...
(declare-var main@%phitmp7_0 Int )
...
(rule (let ((a!1 (and (main@entry @__VERIFIER_nondet_int_0)
                ...
                (=> main@verifier.error_0
                    (= main@%or.cond.i_0 (or main@%i.0.i.lcssa_1 main@%_9_0)))
...
(rule (let ((a!1 (=> main@verifier.error.loopexit_0
               (= main@%phitmp_0 (not (= main@%.lcssa_1 10))))))
(let ((a!2 (and (main@.lr.ph main@%i.0.i3_0
                ...
                a!1
                (=> main@verifier.error.loopexit_0
                    (= main@%phitmp7_0 (* main@%.y.0.i.lcssa_1 2)))
                (=> main@verifier.error_0
                    (and main@verifier.error_0 main@verifier.error.loopexit_0))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%i.0.i.lcssa_0 main@%phitmp_0))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%y.0.i.lcssa_0 main@%phitmp7_0))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%x.0.i.lcssa_0 main@%.lcssa11_1))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%i.0.i.lcssa_1 main@%i.0.i.lcssa_0))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%y.0.i.lcssa_1 main@%y.0.i.lcssa_0))
