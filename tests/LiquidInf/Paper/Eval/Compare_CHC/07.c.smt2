(set-info :original "/tmp/sea-ULK9Ug/07.pp.ms.o.bc")
...
(declare-var main@%b.0.i3_0 Int )
(declare-var main@%i.0.i2_0 Int )
(declare-var main@%a.0.i1_0 Int )
(declare-var main@%b.0.i3_1 Int )
...
(rule (=> (and (main@entry @__VERIFIER_nondet_int_0)
         ...
         main@.lr.ph_0
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0) (= main@%b.0.i3_0 0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0) (= main@%i.0.i2_0 0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0) (= main@%a.0.i1_0 0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0)
             (= main@%b.0.i3_1 main@%b.0.i3_0))
         (=> (and main@.lr.ph_0 main@.lr.ph.preheader_0)
...
(rule (let ((a!1 (and (main@entry @__VERIFIER_nondet_int_0)
                ...
                (=> main@verifier.error_0
                    (= main@%_9_0 (+ main@%b.0.i.lcssa_1 main@%a.0.i.lcssa_1)))
                (=> main@verifier.error_0 (= main@%_10_0 (* main@%_1_0 3)))
                (=> main@verifier.error_0
...
(rule (=> (and (main@.lr.ph main@%_1_0
         ...
         (= main@%a.1.v.i_0 (ite main@%_6_0 2 1))
         (= main@%a.1.i_0 (+ main@%a.1.v.i_0 main@%a.0.i1_0))
         (= main@%b.1.v.i_0 (ite main@%_6_0 1 2))
         (= main@%b.1.i_0 (+ main@%b.1.v.i_0 main@%b.0.i3_0))
         (= main@%_7_0 (+ main@%i.0.i2_0 1))
         (= main@%_8_0 (< main@%_7_0 main@%_1_0))
         (=> main@.lr.ph_1 (and main@.lr.ph_1 main@.lr.ph_0))
         main@.lr.ph_1
         (=> (and main@.lr.ph_1 main@.lr.ph_0) main@%_8_0)
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%b.0.i3_1 main@%b.1.i_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%i.0.i2_1 main@%_7_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0) (= main@%a.0.i1_1 main@%a.1.i_0))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%b.0.i3_2 main@%b.0.i3_1))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%i.0.i2_2 main@%i.0.i2_1))
         (=> (and main@.lr.ph_1 main@.lr.ph_0)
             (= main@%a.0.i1_2 main@%a.0.i1_1)))
    (main@.lr.ph main@%_1_0
                 @__VERIFIER_nondet_int_0
                 main@%a.0.i1_2
                 main@%b.0.i3_2
...
(rule (let ((a!1 (and (main@.lr.ph main@%_1_0
                ...
                (=> (and main@verifier.error.loopexit_0 main@.lr.ph_0)
                    (not main@%_8_0))
                (=> (and main@verifier.error.loopexit_0 main@.lr.ph_0)
                    (= main@%b.1.i.lcssa_0 main@%b.1.i_0))
                (=> (and main@verifier.error.loopexit_0 main@.lr.ph_0)
                ...
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                    (= main@%b.0.i.lcssa_0 main@%b.1.i.lcssa_1))
                (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
