...
{-@ while :: List Int
          ...
          -> n:Int
          -> i:Int
          -> t:{ t:(Int, Int, Int, Int) | (x_Tuple41 t + x_Tuple42 t == k)
                                        && (n > 0 => 0 <= x_Tuple43 t && x_Tuple43 t <= n)
                                        && (n > 0 => 0 <= x_Tuple44 t && x_Tuple44 t < n) }
          -> { t:(Int, Int, Int, Int) | (x_Tuple41 t + x_Tuple42 t == k)
                                      && (n > 0 => 0 <= x_Tuple44 t && x_Tuple44 t < n) }
@-}
