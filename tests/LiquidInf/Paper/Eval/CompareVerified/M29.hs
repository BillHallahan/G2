...
{-@ loop1 :: List Bool
          -> x:Int
          -> y:{ y:Int | x == y }
          -> t:{ t:(Int, Int, Int, Int) | x_Tuple41 t + 1 == x_Tuple44 t && x_Tuple42 t + 1 == x_Tuple43 t }
          -> { t:(Int, Int, Int, Int) | x_Tuple41 t + 1 == x_Tuple44 t && x_Tuple42 t + 1 == x_Tuple43 t } @-}
...
{-@ loop2 :: t:{ t:(Int, Int) | fst t + 1 == snd t } -> { t:(Int, Int) | fst t + 1 == snd t } @-}
