...
-- Similar to nameToStr, but converts a name to Text
nameToText :: Name -> T.Text
nameToText (Name n (Just m) i _) = T.concat [n, "_m_", m, "_", showt i]
nameToText (Name n Nothing i _) = T.concat [n, "_n__", showt i]
...
textToName txt = strToName $ T.unpack txt
