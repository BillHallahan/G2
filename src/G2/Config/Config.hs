...
data Config = Config {
    ...
    , paths_nrpc :: NonRedPathCons -- ^ Whether to use NRPCs for case statements or not
...
mkConfig homedir = Config Regular
    ...
    <*> flag NoNrpc Nrpc (long "paths-nrpc" <> help "use NRPCs to delay execution of case statements that branches more than threshold")
    ...
    <*> flag False True (long "print-paths" <> help "output the number of paths an expression can have)")
