...
main :: IO ()
main = do
    -- timeIOActionPrint $ [g2| \(out :: [Int]) -> ?(i :: [Int]) | compressTest i out |] [2, 1, 2, 3, 4]
    timeIOActionPrint $ [g2M| \(out :: [Int]) -> ?(i :: [Int]) | compressTest i out |] [2, 1, 2, 3, 4]

    -- timeIOActionPrint $ [g2| \(out :: [Int]) -> ?(i :: [Int]) | compressTest2 i out |] [2, 1, 2, 3, 4]
    timeIOActionPrint $ [g2M| \(out :: [Int]) -> ?(i :: [Int]) | compressTest2 i out |] [2, 1, 2, 3, 4]
